<?php
require_once "scheme.php";//подключение класса scheme
require_once "class_order_switchers.php";//подключение класса Заказы
$orderswitcher = new  ClassOrderSwitchers();//создание объекта класса ClassOrderSwitchers

if($_GET["qjump"] == 0) $withoutJump = true;//без перемычек
