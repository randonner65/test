...
for ($n=0; $n<$numJump; $n++){
	if(($jumpArr[0][$n]%2==1)&&($jumpArr[1][$n]%2==1)) outLeftJump1($jumpArr[0][$n], $jumpArr[1][$n]);//вывод левой внешней перемычки
	else if(($jumpArr[0][$n]%2==0)&&($jumpArr[1][$n]%2==0)) outRightJump1($jumpArr[0][$n], $jumpArr[1][$n]);//вывод правой внешней перемычки
	else if(($jumpArr[0][$n]%2==1)&&($jumpArr[1][$n]%2==0)) outLeftRightJump1($jumpArr[0][$n], $jumpArr[1][$n]);//вывод лево-правой внешней перемычки
	else if(($jumpArr[0][$n]%2==0)&&($jumpArr[1][$n]%2==1)) outRightLeftJump1($jumpArr[0][$n], $jumpArr[1][$n]);//вывод право-левой внешней перемычки
	}
